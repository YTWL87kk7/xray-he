...
[![Deploy](https://www.herokucdn.com/deploy/button.png)](https://dashboard.heroku.com/new?template=https://github.com/YTWL87kk7/xray-he)  
...
* **务必替换所有的5a2b8e6f-775f-47c6-b687-9420ffe6610a为部署时设置的AUUID**  
...
* 端口：443
* 默认UUID：5a2b8e6f-775f-47c6-b687-9420ffe6610a
* 加密：none
* 传输协议：ws
* 伪装类型：none
* 路径：/5a2b8e6f-775f-47c6-b687-9420ffe6610a-vless // 默认vless使用/$uuid-vless，vmess使用/$uuid-vmess
* 底层传输安全：tls
```
</details>
...
* 客户端下载: https://github.com/p4gefau1t/trojan-go/releases
{
    ...
    "remote_port": 443,
    "password": [
        "5a2b8e6f-775f-47c6-b687-9420ffe6610a"
    ],
    "websocket": {
        "enabled": true,
        "path": "/5a2b8e6f-775f-47c6-b687-9420ffe6610a-trojan",
...
* 插件选项: tls;host=appname.herokuapp.com;path=/5a2b8e6f-775f-47c6-b687-9420ffe6610a-ss
```
</details>
